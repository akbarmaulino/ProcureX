...
log.logInfo("User login sebagai Admin")
CustomKeywords.'auth.Login.loginAs'('admin')

log.logInfo("User membuka menu Master Data di sidebar")
WebUI.click(findTestObject('Sidebar/sidebar_Master Data'))

log.logInfo("User memilih Master Item")
WebUI.click(findTestObject('Sidebar/subMenu_Master Item'))

log.logInfo("Sistem menampilkan halaman Master Item")
