...
WebUI.setText(findTestObject('MasterItemPage/Item Category/input__description'), 'Batu Bata Update')

WebUI.click(findTestObject('MasterItemPage/Item Group/button_Save'))

CustomKeywords.'helper.VerifyValue.verifyValueExistsInColumn'(1, 'Batu Bata Update')
