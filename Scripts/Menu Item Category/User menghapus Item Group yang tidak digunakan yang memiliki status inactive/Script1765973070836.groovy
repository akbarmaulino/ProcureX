...
WebUI.click(findTestObject('MasterItemPage/Item Category/icon_edit_2'))
...
CustomKeywords.'helper.VerifyValue.verifyToastContains'('Item Category removed successfully')
