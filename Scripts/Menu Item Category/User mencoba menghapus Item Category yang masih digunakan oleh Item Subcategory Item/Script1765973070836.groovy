...
WebUI.click(findTestObject('MasterItemPage/Item Category/icon_delete_2'))

WebUI.click(findTestObject('Object Repository/MasterItemPage/Item Group/button_Confirmation Delete'))

CustomKeywords.'helper.VerifyValue.verifyToastContains'('Failed to delete Item Category')
