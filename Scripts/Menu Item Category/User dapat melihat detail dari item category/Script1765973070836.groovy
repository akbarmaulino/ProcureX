...
WebUI.click(findTestObject('Object Repository/MasterItemPage/Item Group/icon_view'))

WebUI.verifyElementPresent(findTestObject('MasterItemPage/Item Category/PopUp_View Detail'), 10)
